  ...
  switch (opcode) {
    ...
    case HloOpcode::kReduceScatter: {
      ...
      std::shared_ptr<CollectiveDeviceListBase> device_list(
          CollectiveDeviceListBase::DeviceListFromProto(proto).release());
...
/* static */ std::unique_ptr<HloInstruction> HloInstruction::CreateAllGather(
  ...
  return CreateAllGather(shape, operands, all_gather_dimension,
                         device_list.Clone(), constrain_layout, channel_id,
                         use_global_device_ids);
}
...
HloInstruction::CreateAllReduceStart(
    ...
    const CollectiveDeviceListBase& device_list, bool constrain_layout,
    const std::optional<int64_t>& channel_id, bool use_global_device_ids) {
  return CreateAllReduceStart(shape, operands, reduce_computation,
                              device_list.Clone(), constrain_layout, channel_id,
                              use_global_device_ids);
}
...
/* static */ std::unique_ptr<HloInstruction> HloInstruction::CreateAllToAll(
    ...
    const std::optional<int64_t>& channel_id,
    const std::optional<int64_t>& split_dimension) {
  return CreateAllToAll(shape, operands, device_list.Clone(), constrain_layout,
...
HloInstruction::CreateRaggedAllToAll(
    ...
    const CollectiveDeviceListBase& device_list,
    const std::optional<int64_t>& channel_id) {
  return CreateRaggedAllToAll(shape, operands, device_list.Clone(), channel_id);
}
