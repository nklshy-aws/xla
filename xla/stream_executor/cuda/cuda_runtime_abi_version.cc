...
constexpr absl::string_view kCudaPlatformName = "CUDA";
...
CudaRuntimeAbiVersion::FromProto(CudaRuntimeAbiVersionProto proto) {
  ASSIGN_OR_RETURN(
...
absl::StatusOr<std::unique_ptr<CudaRuntimeAbiVersion>>
CudaRuntimeAbiVersion::FromProto(absl::string_view proto) {
...
absl::StatusOr<RuntimeAbiVersionProto> CudaRuntimeAbiVersion::ToProto() const {
  ...
  proto.set_platform_name(kCudaPlatformName);
...
absl::Status CudaRuntimeAbiVersion::IsCompatibleWith(
  ...
  if (executable_proto.platform_name() != kCudaPlatformName) {
    return absl::FailedPreconditionError(
        absl::StrCat("Platform name mismatch. Expected ", kCudaPlatformName,
