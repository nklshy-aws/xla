...
FuncOp cloneFuncRecursively(FuncOp funcOp, SymbolTable& symbolTable) {
  ...
  CHECK(funcOp) << "Failed to lookup function: " << originalFuncName.str();
...
class SdyRoundTripFlattenCallGraphPass
 ...
 public:
  ...
  StringRef getArgument() const override { return "xla-sdy-flatten"; }

  StringRef getDescription() const override { return "Flattens the graph."; }
